//This project is a combination of two of my assignment

boolean displayPiano = true;//set the apparition of the piano
boolean smallHouse  = false;//If display piano is shown the small house is not show
...
void mousePressed() { //Change the color of the small square 
  fill(204, 153, 0);
  xMove = random(0, 2); // Assign a random value to xMove
  yMove = random(2, 1); // Assign a random value to yMove 
} 
void resetSketch() {
  displayPiano = true;
  smallHouse  = false;
